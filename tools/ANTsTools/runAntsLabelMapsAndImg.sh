...
radiusnbins=3
stepsize=0.25 
updatefield=3 # fluid deformation 
...
echo antsRegistration -d $dim --interpolation $interp $rigid $affine $syn $out -v
antsRegistration -d $dim --interpolation $interp $rigid $affine $syn $out -v
