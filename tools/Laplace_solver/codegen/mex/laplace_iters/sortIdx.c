...
static emlrtRSInfo t_emlrtRSI = { 105, /* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo u_emlrtRSI = { 308, /* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo v_emlrtRSI = { 316, /* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo w_emlrtRSI = { 317, /* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo x_emlrtRSI = { 325, /* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo y_emlrtRSI = { 333, /* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};
...
static emlrtRSInfo db_emlrtRSI = { 587,/* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo eb_emlrtRSI = { 589,/* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo fb_emlrtRSI = { 617,/* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo gb_emlrtRSI = { 499,/* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo ib_emlrtRSI = { 507,/* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo jb_emlrtRSI = { 514,/* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo kb_emlrtRSI = { 561,/* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRSInfo lb_emlrtRSI = { 530,/* lineNo */
  "sortIdx",                           /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pathName */
};

static emlrtRTEInfo rb_emlrtRTEI = { 61,/* lineNo */
  5,                                   /* colNo */
  "sortIdx",                           /* fName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pName */
};

static emlrtRTEInfo sb_emlrtRTEI = { 386,/* lineNo */
  1,                                   /* colNo */
  "sortIdx",                           /* fName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pName */
};
...
static emlrtRTEInfo vb_emlrtRTEI = { 308,/* lineNo */
  20,                                  /* colNo */
  "sortIdx",                           /* fName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/sortIdx.m"/* pName */
};
...
void sortIdx(const emlrtStack *sp, emxArray_real_T *x, emxArray_int32_T *idx)
{
  ...
  m = idx->size[0];
  idx->size[0] = ib;
  emxEnsureCapacity_int32_T(sp, idx, m, &rb_emlrtRTEI);
  for (m = 0; m < ib; m++) {
    idx->data[m] = 0;
  }
  ...
  if (x->size[0] != 0) {
    ...
    emxInit_int32_T(&b_st, &iwork, 1, &ub_emlrtRTEI, true);
    m = iwork->size[0];
    iwork->size[0] = ib;
    emxEnsureCapacity_int32_T(&b_st, iwork, m, &sb_emlrtRTEI);
    for (m = 0; m < ib; m++) {
      iwork->data[m] = 0;
    }

    emxInit_real_T1(&b_st, &xwork, 1, &vb_emlrtRTEI, true);
    i = x->size[0];
    m = xwork->size[0];
    xwork->size[0] = i;
    emxEnsureCapacity_real_T2(&b_st, xwork, m, &tb_emlrtRTEI);
    for (m = 0; m < i; m++) {
      xwork->data[m] = 0.0;
    }
