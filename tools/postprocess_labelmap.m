...
% system([getenv('AUTOTOP_DIR') '/tools/ANTsTools/runAntsLabelMaps_AffOnly.sh '...
%     tmpdir '/labelmap-midProcess.nii.gz '...
%     getenv('AUTOTOP_DIR') '/atlases/UPenn_ExVivo/Avg_lbl_JDedit.nii.gz '... % no DG yet
%     tmpdir '/labelmap-midProcess_UPennAtlasReg-Aff']);
system(['flirt -ref ' tmpdir '/labelmap-midProcess.nii.gz '...
    '-in ' getenv('AUTOTOP_DIR') '/atlases/UPenn_ExVivo/Avg_lbl_JDedit.nii.gz '...
...
system(['c3d_affine_tool ' tmpdir '/labelmap-midProcess_UPennAtlasReg-Aff-itk.mat '...
    '-src  ' getenv('AUTOTOP_DIR') '/atlases/UPenn_ExVivo/Avg_lbl_JDedit.nii.gz '...
...
system(['antsApplyTransforms -d 3 --interpolation NearestNeighbor '...
    '-i ' getenv('AUTOTOP_DIR') '/atlases/UPenn_ExVivo/Avg_lbl_JDedit_withDG_withDummy.nii.gz '... % now apply to labelmap with DG
...
system(['antsApplyTransforms -d 3 --interpolation NearestNeighbor '...
    '-i ' getenv('AUTOTOP_DIR') '/atlases/UPenn_ExVivo/Avg_lbl_JDedit.nii.gz '...
...
%         '-i ' getenv('AUTOTOP_DIR') '/atlases/UPenn_ExVivo/Avg_img.nii.gz '...
...
%     system([getenv('AUTOTOP_DIR') '/tools/ANTsTools/runAntsImgs_SynOnly.sh '...
%         tmpdir '/img_noCyst_noHeader.nii.gz '...
...
system(['antsApplyTransforms -d 3 --interpolation NearestNeighbor '...
    '-i ' getenv('AUTOTOP_DIR') '/atlases/UPenn_ExVivo/coords-AP.nii.gz '...
...
system(['antsApplyTransforms -d 3 --interpolation NearestNeighbor '...
    '-i ' getenv('AUTOTOP_DIR') '/atlases/UPenn_ExVivo/coords-PD.nii.gz '...
...
system(['antsApplyTransforms -d 3 --interpolation NearestNeighbor '...
    '-i ' getenv('AUTOTOP_DIR') '/atlases/UPenn_ExVivo/coords-IO.nii.gz '...
